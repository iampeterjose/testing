  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative flex items-center justify-center w-32 h-32 md:w-44 md:h-44 mb-4">
          <div className="absolute inset-0 bg-orange-100 rounded-full blur-xl opacity-60 z-0" />
          <img
            src={image}
            alt={title}
            className="relative z-10 w-24 h-24 md:w-36 md:h-36 object-cover rounded-xl shadow-md border-4 border-white"
          />
